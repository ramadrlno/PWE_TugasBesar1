...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <form action="<?php echo e(url('produk/edit/' . $ubahproduk->kode_produk)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\ella3\OneDrive\Dokumen\UNIVERSITAS MERCU BUANA\SEMESTER 5\PWE\Atilla Kuncoro Djati\atillakd\resources\views/editproduk.blade.php ENDPATH**/ ?>